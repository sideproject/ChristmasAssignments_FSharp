...
let christopher =   { FirstName="christopher";  LastName="1"; AgeType="child";  Previous=[ "shawn";       "daniel";      "anne";        "carla";       "laura";       "joeseph";     "charlie";      ]}
...
let jacob =         { FirstName="jacob";        LastName="1"; AgeType="child";  Previous=[                                                                            "X"            "joeseph";      ]}
...
let laura =         { FirstName="laura";        LastName="2"; AgeType="child";  Previous=[ "martha";      "andrew";      "jimmy";       "joeseph";     "daniel";      "dean";        "sam";          ]}
let tyler =         { FirstName="tyler";        LastName="2"; AgeType="child";  Previous=[                                                             "X";           "elise";       "dean";         ]}
...
let andrew =        { FirstName="andrew";       LastName="3"; AgeType="child";  Previous=[ "joeseph";     "sam";         "frank";       "laura";       "sarah";       "julia";       "elise";        ]}
...
let carla =         { FirstName="carla";        LastName="4"; AgeType="parent"; Previous=[ "anne";        "mary";        "dean";        "hollie";      "joeseph";     "shawn";       "emily";        ]}
let mallory =       { FirstName="mallory";      LastName="4"; AgeType="child";  Previous=[ "christopher"; "joseph";      "amie";        "james";       "mary";        "hollie";      "andrew";       ]}
...
let joeseph =       { FirstName="joeseph";      LastName="5"; AgeType="child";  Previous=[ "andrew";      "laura";       "julia";       "sarah";       "eliz";        "mallory";     "margaret";     ]}
