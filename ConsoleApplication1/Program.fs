...
let christopher =   { FirstName="christopher";  LastName="1"; AgeType="child";  Previous=[ "shawn";       "daniel";      "anne";        "carla";       "laura";       "joseph";     "charlie";      "martha";      ]}
...
let jacob =         { FirstName="jacob";        LastName="1"; AgeType="child";  Previous=[                                                                            "X";           "joseph";      "sam";         ]}
...
let laura =         { FirstName="laura";        LastName="2"; AgeType="child";  Previous=[ "martha";      "andrew";      "jimmy";       "joseph";      "daniel";      "dean";        "sam";         "sarah";       ]}
let tyler =         { FirstName="tyler";        LastName="2"; AgeType="child";  Previous=[                                                             "X";           "elise";       "dean";        "joseph";      ]}
...
let andrew =        { FirstName="andrew";       LastName="3"; AgeType="child";  Previous=[ "joseph";      "sam";         "frank";       "laura";       "sarah";       "julia";       "elise";       "mallory";     ]}
...
let carla =         { FirstName="carla";        LastName="4"; AgeType="parent"; Previous=[ "anne";        "mary";        "dean";        "hollie";      "joseph";      "shawn";       "emily";       "amie";        ]}
...
let james =         { FirstName="james";        LastName="5"; AgeType="child";  Previous=[ "mallory";     "christopher"; "sarah";       "elise";       "margaret";    "amie";        "jimmy";       "tyler";       ]}
let joseph =        { FirstName="joseph";       LastName="5"; AgeType="child";  Previous=[ "andrew";      "laura";       "julia";       "sarah";       "eliz";        "mallory";     "margaret";    "megan";       ]}
let sarah =         { FirstName="sarah";        LastName="6"; AgeType="parent"; Previous=[ "charlie";     "margaret";    "james";       "julia";       "amie";        "andrew";      "anne";        "laura";       ]}
